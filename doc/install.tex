...
pkg/xgap/README         -- extracted as text
pkg/xgap/Makefile.in    -- extracted as text
pkg/xgap/configure      -- extracted as text
pkg/xgap/configure.in   -- extracted as text
pkg/xgap/init.g         -- extracted as text
/bin/mkdir: Erzeugen des Verzeichnisses `pkg' nicht möglich: File exists
...
\endtt
