...
\begintt
# make
mkdir -p bin/x86\_64-unknown-linux-gnu-gcc
cp cnf/configure.out bin/x86\_64-unknown-linux-gnu-gcc/configure
( cd bin/x86\_64-unknown-linux-gnu-gcc ; CC=gcc ./configure  )
checking for gcc... gcc
...
creating Makefile
creating config.h
( cd bin/x86\_64-unknown-linux-gnu-gcc ; make CC=gcc )
make[1]: Entering directory 
`/scratch/neunhoef/4.0/pkg/xgap/bin/x86\_64-unknown-linux-gnu-gcc'
...
\begintt
bin/x86\_64-unknown-linux-gnu-gcc/xgap
\endtt
