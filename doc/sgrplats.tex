...
been possible to   find vertex $4$ using  <Epimorphisms>  instead of <Low
...
Select <PSL(d,q)>, which pops up a dialog box asking for a dimension. Enter
``2'' and click on <OK>. Then a second dialog box pops up asking for a
field size. Enter ``11'' and click on <OK>. After a short time of
computation the display in the <Epimorphisms> menu changes and shows
