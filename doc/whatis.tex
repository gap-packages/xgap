...
concepts like graphs or posets {\XGAP} provides implementations which can
...
and change the {\GAP} accordingly.
...
libraries. They are found in the `pkg/xgap/lib' directory normally in the
...
at least operating system dependend. There is no generic way to access
