...
implemented by H. Juergensen in 1965 (see \cite{FJ65}).
...
Neunh\accent127offer invented the new concepts for the {\GAP4}
version. The implementation and portation to {\GAP4} was done mainly by Max
Neunh\accent127offer in 1998 and 1999. 
